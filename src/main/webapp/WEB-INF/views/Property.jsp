		...
		<h2 class="mb-4">Add New Property</h2>
			...
			<div class="mb-3">
				<label for="basePrice" class="form-label">Base Price:</label> <input
					type="number" class="form-control" id="basePrice" name="basePrice"
					required>
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<div class="mb-3">
					<label for="propertyPic" class="form-label">Upload
						Property Images (Max 2):</label> <input type="file" class="form-control"
						id="propertyPic" name="propertyPic" accept="image/*"
						multiple required>
				</div>
